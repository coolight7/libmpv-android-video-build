...
sed -i '/^Libs: -L${libdir} -ljxl / s|-lc++ |-lc++_shared|' "$prefix_dir/lib/pkgconfig/libjxl.pc"
sed -i '/^Libs.private:/ s|-lc++ |-lc++_shared|' "$prefix_dir/lib/pkgconfig/libjxl_cms.pc"
sed '/^Libs.private:/ s|$| -lc++_shared|' "$prefix_dir/lib/pkgconfig/libjxl_threads.pc" -i