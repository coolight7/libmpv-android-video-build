...
stripLib() {
  "./sdk/android-sdk-linux/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip" --strip-all prefix-21/arm64-v8a/lib/$1
  "./sdk/android-sdk-linux/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip" --strip-all prefix-21/armeabi-v7a/lib/$1
  "./sdk/android-sdk-linux/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip" --strip-all prefix-21/x86/lib/$1
  "./sdk/android-sdk-linux/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip" --strip-all prefix-21/x86_64/lib/$1
}
...
copyLib() {
  ...
  # cp ../../prefix-21/$1/lib/stdcxx/libc++_shared.so                          app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/libmediaxx.so                                    app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/libmpv.so                                        app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libswresample.so                   app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libswscale.so                      app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libavutil.so                       app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libavcodec.so                      app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libavformat.so                     app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libavfilter.so                     app/build/outputs/apk/release/lib/$1/
  cp ../../prefix-21/$1/lib/ffmpeg-backup/libavdevice.so                     app/build/outputs/apk/release/lib/$1/
}
